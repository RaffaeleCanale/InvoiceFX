 ...
 */
public class SuggestionTextField<T> extends TextField {
    ...
    private Consumer<T> itemConsumer;// = item -> setTextSilent(toStringFn.apply(item));
    ...
    public void showEntries(Map<String, T> searchResult) {
        ...
        if (!entriesPopup.isShowing()) {
            entriesPopup.show(SuggestionTextField.this, Side.BOTTOM, 0, 0);
        }
    }
