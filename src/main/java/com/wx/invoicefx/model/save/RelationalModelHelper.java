...
public class RelationalModelHelper {
    ...
    public static Invoice getInvoiceModel(List<Purchase> purchases, Object[] record) {
    ...
    public static Object[] getPurchaseRecord(Invoice invoice, Client client, Purchase purchase) {
        return new Object[] {
                invoice.getId(),
                client.getId(),
    ...
    public static Purchase getPurchaseModel(Client client, Item item, Object[] record) {
