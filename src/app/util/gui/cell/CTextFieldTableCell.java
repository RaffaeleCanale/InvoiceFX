 ...
 * @since JavaFX 2.2
 */
public class CTextFieldTableCell<S,T> extends TableCell<S,T> {
     ...
     * input from the TextField (as it will not know how to convertDoubleArray this back
     * to the domain object). It is therefore strongly encouraged to not use
     * this constructor unless you intend to set the converter separately.
     */
    public CTextFieldTableCell() {
        this(null);
    }
     ...
     * will convertDoubleArray the given String (from what the user typed in) into an
     * instance of type T. This item will then be passed along to the 
     * {@link TableColumn#onEditCommitProperty()} callback.
     *
     * @param converter A {@link StringConverter converter} that can convertDoubleArray
     *      the given String (from what the user typed in) into an instance of 
     *      type T.
     */
    public CTextFieldTableCell(StringConverter<T> converter) {
